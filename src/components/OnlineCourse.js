      ...
      <div>
        <div className="open-source-container">
          ...
          <div className="course-details">
            <h2>
              EECE 230X: Introduction to Computation and Programming Using
              Python
            </h2>
            <p>
              Dive into the field of computer science, irrespective of your
              coding experience using Python with an emphasis on elementary
              algorithmic ideas.{" "}
            </p>
