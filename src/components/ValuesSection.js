      ...
      <div className="about-us-content">
        <div className="about-us-left">
          ...
          <div>
            ...
            <p style={{marginTop:"20px"}}>Check out our <a  href="../pdfs/bylaws.pdf" target="_blank" rel="noopener noreferrer" >Bylaws</a> and <a  target="_blank" rel="noopener noreferrer"  >Best Practices</a> to learn more about us!</p>
          </div>
        </div>
